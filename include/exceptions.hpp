...
private:
    ...
    qint64 statusCode;    ///< Код ошибки (для логирования/отладки)
...
public:
     ...
     */
    ExceptionCreateResponse(const QString& msg, const qint64 statusCode);
};
...
public:
     ...
     * @param statusCode Код ошибки
     */
    ExceptionCreateRequest(const QString& msg, const qint64 statusCode);
};
